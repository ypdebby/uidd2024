...
import person4 from "./img/personal_picture/01-黃政文.png";
import person5 from "./img/personal_picture/02-蘇奕幃.png";
import person3 from "./img/personal_picture/03-王三禾.png";
import person2 from "./img/personal_picture/04-紹紹.png";
import person1 from "./img/personal_picture/05-曾鈺蘋.png";
  ...
  return (
    <body>
      ...
      <div className="personal_introduce" >
        <img className="personsmall" id="person1" onMouseEnter={() => handleHover("person1")} src={person1} alt="person1" />
        <img className="personsmall" id="person2" onMouseEnter={() => handleHover("person2")} src={person2} alt="person2" />
        <img className="personsmall" id="person3" onMouseEnter={() => handleHover("person3")} src={person3} alt="person3" />
        <img className="personsmall" id="person4" onMouseEnter={() => handleHover("person4")} src={person4} alt="person4" />
        <img className="personsmall" id="person5" onMouseEnter={() => handleHover("person5")} src={person5} alt="person5" />
